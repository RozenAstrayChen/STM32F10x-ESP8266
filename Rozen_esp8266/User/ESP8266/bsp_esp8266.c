...
bool ESP8266_SET_SINGLE(void){
	char cCmd[120];
	sprintf(cCmd,"AT+CIPMUX=0");
	//SendData_uart2(strEsp8266_Fram_Record .Data_RX_BUF);
	return ESP8266_Cmd ( cCmd, "OK", 0, 4000 );
}
bool ESP8266_HTTP_CIPTEST(void){
	char cCmd[120];
	
	sprintf ( cCmd, "AT+CIPSEND=?"	);
	//SendData_uart2(strEsp8266_Fram_Record .Data_RX_BUF);		//return data to uart2
	
	return ESP8266_Cmd ( cCmd, "OK", 0, 4000 );
}
/*need use ESP8266_HTTP_CIPSEND*/
bool ESP8266_HTTP_CIPSEND(void){
	char cCmd[120];
	sprintf ( cCmd, "AT+CIPSEND=31\r\n"	);//
	//SendData_uart2(strEsp8266_Fram_Record .Data_RX_BUF);		//return data to uart2
	return ESP8266_Cmd ( cCmd, ">", 0, 500 );
	
}
bool ESP8266_HTTP_GET(void){
	char cCmd[120];
	delay_ms(1000);
	sprintf ( cCmd, "GET /\r\n"	);
	delay_ms(1000);
	//SendData_uart2(strEsp8266_Fram_Record .Data_RX_BUF);		//return data to uart2
	return ESP8266_Cmd ( cCmd, "SEND OK", 0, 500 );
}
/*
